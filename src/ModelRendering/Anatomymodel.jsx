...
function Anatomymodel (props) {
  const { skinColor, setSkinColor, selectedGender, setGender} = useCharacterCustomization();
  ...
  useEffect(() => {
    // Set the skin color based on the selected gender
    setSkinColor(`#${materials.MBLab_skin2.color.getHexString()}`);
  }, [setSkinColor, materials.MBLab_skin2, selectedGender]);
  
  return (
    <group {...props} dispose={null}>
      {selectedGender === 'female' ? (
        // Render female meshes here
      <>
